...
<body>
    ...
    <div class="container">
        <div class="card bg-body-secondary">
            <div class="container">
                <br>
                <h4>Apakah anda yakin ingin menghapus akun anda?</h4><br>
                <p>Anda tidak akan dapat mengembalikan kembali akun anda!</p>
                <form action="" method="post">
                    <input type="submit" name="delete_data" value="Delete Data" class="btn btn-danger">
